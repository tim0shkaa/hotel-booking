...
class BookingServiceTest {
    ...
    private val guestEntity1 = GuestEntity(
        id = UUID.randomUUID(),
        firstName = "Алексей",
        surname = "Тимохин",
    ...
    private val guestEntity2 = GuestEntity(
        id = UUID.randomUUID(),
        firstName = "Петров",
        surname = "Петр",
        patronymic = null,
    ...
    fun `findBookingById returns response when booking exists`() {
        ...
        assertEquals(OffsetDateTime.of(2025, 3, 10, 14, 0, 0, 0, ZoneOffset.UTC),
            result.checkIn)
        assertEquals(OffsetDateTime.of(2025, 3, 15, 12, 0, 0, 0, ZoneOffset.UTC),
    ...
    fun `updateBooking returns updated response when booking exists`() {
        ...
        assertNotNull(result)
        assertEquals(OffsetDateTime.of(2025, 4, 1, 14, 0, 0, 0, ZoneOffset.UTC),
            result.checkIn)
        assertEquals(OffsetDateTime.of(2025, 4, 5, 12, 0, 0, 0, ZoneOffset.UTC),
            result.checkOut)
